...
SPEECH_FILE="/lm/ctc_model_new/test.wav"
print(SPEECH_FILE)


# /home/chenyang/chenyang_space/ctc_model_new/pretrained_ctc/model_999.pth
# bundle = torchaudio.pipelines.WAV2VEC2_ASR_BASE_960H
model=torch.load("/lm/ctc_model_new/pretrained_ctc/model_19.pth")
model = model.to(device)
with open("/lm/ctc_model_new/data/data_aishell/labels.json") as f:
